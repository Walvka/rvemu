...
#define FUNCT2(data)    (((data) >> 25) & 0x03)
#define FUNCT3(data)    (((data) >> 12) & 0x07)
...
static inline insn_t insn_btype_read(u32 data){
    u32 imm12   = (data >> 31) & 0x01;
    u32 imm105  = (data >> 25) & 0x3f;
    u32 imm41   = (data >>  8) & 0x0f;
    u32 imm11   = (data >>  7) & 0x01;
...
static inline insn_t insn_jtype_read(u32 data) {
    u32 imm20   = (data >> 31) & 0x01;
    u32 imm101  = (data >> 21) & 0x03ff;
    u32 imm11   = (data >> 20) & 0x01;
