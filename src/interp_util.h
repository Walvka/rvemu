...
union uint32_t_f32 { uint32_t ui; f32 f; };
...
inline uint16_t f32_classify(f32 a) {
    union uint32_t_f32 uA;
    uint32_t uiA;
...
union uint64_t_f64 { uint64_t ui; f64 f; };
...
inline uint16_t f64_classify(f64 a) {
    union uint64_t_f64 uA;
    uint64_t uiA;
